    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AuthorDesign.DAL.AuthorDesignContext>
    {
        ...
        protected override void Seed(AuthorDesign.DAL.AuthorDesignContext context)
        {
            ...
            context.Admins.AddOrUpdate(
                p => p.AdminName,
                new Admin() { AdminName = "admin", CreateTime = DateTime.Now, IsLogin = 1, Salt = "1234567890", Password = "42C224B3C8899047460F5A6D1C041411", LastLoginAddress = "´óÖÐ»ª", LastLoginIp = "192.168.0.1", LastLoginTime = DateTime.Now, IsSuperAdmin = 1 }
          );
