...
namespace AuthorDesign.Web.Areas.Admin.Controllers
{
    ...
    {
        [AdminActionMethod(RoleCode = "Look", ActionUrl = "PageMenu/PageMenuList")]
        ...
        /// <returns></returns>
        [HttpPost]
        [AdminActionMethod(RoleCode = "Look", ActionUrl = "PageMenu/PageMenuList", ActionResultType = 1)]
        ...
        /// <returns></returns>
        [HttpPost]
        [AdminActionMethod(RoleCode = "Update", ActionUrl = "PageMenu/PageMenuList", ActionResultType = 1)]
        ...
        /// <returns></returns>
        [HttpPost]
        [AdminActionMethod(RoleCode = "Del", ActionUrl = "PageMenu/PageMenuList", ActionResultType = 1)]
        ...
        /// <returns></returns>
        [HttpPost]
        [AdminActionMethod(RoleCode = "PagePermission_Look", ActionUrl = "PageMenu/PageMenuList", ActionResultType = 1)]
        ...
        /// <returns></returns>
        [HttpPost]
        [AdminActionMethod(RoleCode = "PagePermission_Update", ActionUrl = "PageMenu/PageMenuList", ActionResultType = 1)]
