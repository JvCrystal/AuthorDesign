...
namespace AuthorDesign.Web.Areas.Admin.Controllers
{
    ...
    public class PageActionController : Controller
    {
        ...
        [AdminActionMethod(RoleCode = "Look", ActionUrl = "PageAction/PageActionList")]
        ...
        /// <returns></returns>
        [HttpPost]
        [AdminActionMethod(RoleCode = "Look", ActionUrl = "PageAction/PageActionList", ActionResultType = 1)]
        ...
        /// <returns></returns>
        [HttpPost]
        [AdminActionMethod(RoleCode = "Update", ActionUrl = "PageAction/PageActionList", ActionResultType = 1)]
